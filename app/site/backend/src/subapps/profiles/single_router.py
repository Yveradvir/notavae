...
from app.site.backend.src.utils.const import OneResultedResponse, NoneResultedResponse, PasswordedRequest
...
@single_router.delete(path="", response_model=NoneResultedResponse, dependencies=[Depends(jwtsecure.depend_access_token)])
